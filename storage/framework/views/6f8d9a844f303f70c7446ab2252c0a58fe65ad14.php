...
<script type="text/javascript">
  $(document).on('click','#search',function(){
    ...
    var exam_type_id = $('#exam_type_id').val();
     $.ajax({
      url: "<?php echo e(route('student.exam.fee.classwise.get')); ?>",
      type: "get",
...
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\schoolmanagement\resources\views/backend/student/exam_fee/exam_fee_view.blade.php ENDPATH**/ ?>