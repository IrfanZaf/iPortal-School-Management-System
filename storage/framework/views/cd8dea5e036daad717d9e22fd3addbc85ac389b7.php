		...
		<div class="account-form-inner">
			<div class="account-container">
				<div class="heading-bx left">
				  ...
				  <form method="POST" action="<?php echo e(route('login')); ?>" class="contact-bx">
            <?php echo csrf_field(); ?>
					 ...
					 <input type="email" id="email" name="email" class="form-control" placeholder="">
						...
						<div class="col-lg-12">
							<div class="form-group form-forget">
							  ...
							  <a href="<?php echo e(route('password.request')); ?>" class="ml-auto"></i> Forgot Password?</a>
								</di
							</div>
						</div>
...
<?php /**PATH C:\xampp\htdocs\schoolmanagement\resources\views/auth/login.blade.php ENDPATH**/ ?>