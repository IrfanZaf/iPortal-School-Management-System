...
<?php endif; ?>
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>  SM System Registration </title>
		...
		<div class="account-form-inner">
			<div class="account-container">
				<div class="heading-bx left">
					...
					<p>Login Your Account <a href="<?php echo e(route('login')); ?>">Click here</a></p>
				</div>	
                <form method="POST" action="<?php echo e(route('register')); ?>" class="contact-bx">
...
<?php /**PATH C:\xampp\htdocs\schoolmanagement\resources\views/auth/register.blade.php ENDPATH**/ ?>